...
Login using demo credentials or create a new account
🔑 Demo Credentials
...
Theme → ff_theme_<email>
Transactions → ff_transactions_<email>
⚠️ Note

This project is frontend-only and intended for UI/demo purposes.
